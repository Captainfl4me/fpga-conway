...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "data_latency" -parent ${Page_0}
...
proc update_PARAM_VALUE.data_latency { PARAM_VALUE.data_latency } {
	# Procedure called to update data_latency when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.data_latency { PARAM_VALUE.data_latency } {
	# Procedure called to validate data_latency
	return true
}
...
proc update_MODELPARAM_VALUE.data_latency { MODELPARAM_VALUE.data_latency PARAM_VALUE.data_latency } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.data_latency}] ${MODELPARAM_VALUE.data_latency}
}
