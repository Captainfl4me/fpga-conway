...
design_libs=(xpm xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_16)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../fpga_conway.gen/sources_1/bd/conway_top/ipshared/3cbc" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../fpga_conway.gen/sources_1/bd/conway_top/ipshared/3cbc" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conway_top xil_defaultlib.glbl -o conway_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conway_top_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nicoth/projects/fpga_conway/fpga_conway.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key conway_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conway_top_simv.daidir vcs_lib c.obj)
