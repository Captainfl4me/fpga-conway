...
#
# Script generated by Vivado on Sun Oct 19 20:59:30 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conway_top.sh
...
#
# Usage        : conway_top.sh
#                conway_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conway_top.sh [-reset_run]
#                conway_top.sh [-reset_log]
#                conway_top.sh [-help]
#
...
#                script (type 'conway_top.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_16)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "conway_top.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conway_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../fpga_conway.gen/sources_1/bd/conway_top/ipshared/3cbc" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../fpga_conway.gen/sources_1/bd/conway_top/ipshared/3cbc" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.conway_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.conway_top -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nicoth/projects/fpga_conway/fpga_conway.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log conway_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conway_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conway_top.sh [-help]\n\
Usage: conway_top.sh [-step]\n\
Usage: conway_top.sh [-lib_map_path]\n\
Usage: conway_top.sh [-reset_run]\n\
Usage: conway_top.sh [-reset_log]\n\
Usage: conway_top.sh [-keep_index]\n\
Usage: conway_top.sh [-noclean_files]\n\n\
