...
#
# Script generated by Vivado on Sun Oct 19 20:04:17 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conway_tb.sh
...
#
# Usage        : conway_tb.sh
#                conway_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conway_tb.sh [-reset_run]
#                conway_tb.sh [-reset_log]
#                conway_tb.sh [-help]
#
...
#                script (type 'conway_tb.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname sim_clk_gen_v1_0_5 -libname xil_defaultlib -libname xlconstant_v1_1_9 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm sim_clk_gen_v1_0_5 xil_defaultlib xlconstant_v1_1_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "conway_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conway_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work sim_clk_gen_v1_0_5 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.conway_tb xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.conway_tb -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log conway_tb_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conway_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conway_tb.sh [-help]\n\
Usage: conway_tb.sh [-step]\n\
Usage: conway_tb.sh [-lib_map_path]\n\
Usage: conway_tb.sh [-reset_run]\n\
Usage: conway_tb.sh [-reset_log]\n\
Usage: conway_tb.sh [-keep_index]\n\
Usage: conway_tb.sh [-noclean_files]\n\n\
