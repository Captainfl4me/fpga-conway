...
design_libs=(xpm sim_clk_gen_v1_0_5 xil_defaultlib xlconstant_v1_1_9)
...
compile()
{
  ...
  vlogan -work sim_clk_gen_v1_0_5 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conway_tb xil_defaultlib.glbl -o conway_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conway_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key conway_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conway_tb_simv.daidir vcs_lib c.obj)
