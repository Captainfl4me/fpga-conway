...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L sim_clk_gen_v1_0_5 -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot conway_tb xil_defaultlib.conway_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conway_tb -key {Behavioral:sim_1:Functional:conway_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/conway_top.protoinst" -protoinst "protoinst_files/conway_tb.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conway_tb.wdb xsim.dir libdpi.so)
